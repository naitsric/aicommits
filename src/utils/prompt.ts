...
export const generateCodeReviewPrompt = (
	...
	`Message language: ${locale}`,
	'Exclude anything unnecessary, such as translations and the analysis of unused variables. Your entire response will be part of the code analysis and review. Include a concise summary of the code analysis, a linter check, and a spelling check; if you find errors, redundancies, syntax errors, or typos, include them in the summary. If findings are identified during the analysis, provide the relevant recommendations. Additionally, make sure to include the name of the file you are analyzing in the diff. I expect these data to be presented in a table. Only inform me of incidents; if things are correct or within normal parameters, it is not necessary to report them.',
].filter(Boolean).join('\n');
